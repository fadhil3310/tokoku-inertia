...
export default function Home({ upcomingEvents, pastEvents }) {
    ...
    const featuredEvent = upcomingEvents?.[0] || pastEvents?.[0] || {
        ...
        city: 'Jakarta, ID',
        description: 'Join thousands of innovators and tech enthusiasts at the premier technology exhibition of the year.',
        ...
        <>
            ...
            <div className="flex flex-col min-h-screen bg-gray-50">
                ...
                <section className="pt-32 pb-24 px-6 md:px-12 lg:px-24 overflow-hidden relative text-white min-h-150 flex items-center">
                    ...
                    />
                    <div
                        className={`absolute inset-0 z-1 bg-cover bg-center mix-blend-overlay transition-opacity duration-1000 ${heroSlide === 1 ? 'opacity-50' : 'opacity-0'}`}
                    ...
                    {/* Content Container (Grid trick for overlaying slides without absolute height issues) */}
                    <div className="max-w-7xl mx-auto w-full grid relative z-10">
                        
                        {/* SLIDE 0: Featured Event */}
                        ...
                        <div className={`col-start-1 row-start-1 w-full flex flex-col lg:flex-row items-center gap-16 transition-all duration-700 ${heroSlide === 1 ? 'opacity-100 translate-y-0 z-10 pointer-events-auto' : 'opacity-0 translate-y-8 -z-10 pointer-events-none'}`}>
                ...
                <footer className="px-6 py-16 bg-white border-t border-gray-200">
                    ...
                    <div className="max-w-7xl mx-auto pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
                        <div className="flex items-center gap-2">
                            <div className="w-6 h-6 rounded bg-linear-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-xs">T</div>
