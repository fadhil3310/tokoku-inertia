            ...
            <div className="p-4 lg:p-6 w-full">
                <nav className="flex items-center space-x-2 text-sm mb-6">
                    <Link
                        ...
                        className="flex items-center text-gray-700 hover:text-blue-500 hover:cursor-pointer fill-current"
                    >
                        <svg
                            width="24"
                            height="24"
                    ...
                    <Link
                        onClick="parent.postMessage({ 'type': 'page', 'to': 'transactions' }, '*')"
                        className="flex items-center text-gray-700 hover:text-blue-500 hover:cursor-pointer"
                    >
                        Transactions
                    </Link>
                    <svg
                ...
                <div className="mb-6">
                    ...
                    <p className="text-gray-600">
                        Ask customer to complete the payment.
                    </p>
                </div>
                <form
                ...
                >
                    <div className="space-y-6">
                        <div className="card bg-white p-6 rounded-lg shadow transition-all duration-200 flex flex-col items-center space-y-4">
                            <div className="w-full text-left">
                                <h3 className="text-sm font-medium text-gray-700">
                                    Scan to Pay
                                </h3>
                                <p className="text-xs text-gray-500 mt-1">
                                    Scan with any supported e-wallet or banking
                                    app
                                </p>
                            </div>
                            <div className="p-3 bg-white border border-gray-200 rounded-xl shadow-sm inline-block">
                                <img
                                    src="https://api.qrserver.com/v1/create-qr-code/?size=160x160&data=TokakuBoothDummyTransaction"
                                    alt="QRIS Barcode"
                                    className="w-40 h-40 object-contain"
                                />
                            </div>
                        </div>
                        <div className="card text-red-500 bg-white p-6 rounded-lg shadow transition-all duration-200 space-y-4">
                            <div className="space-y-2">
                                <div className="flex items-center justify-between text-sm">
                                    <span>Expires in:</span>
                                    <span id="timer" className="font-medium">
                                        05:00
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div className="card bg-white p-6 rounded-lg shadow transition-all duration-200 space-y-4">
